        ...
        <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          ...
          <div className="prose-legal mt-10 space-y-8 text-body leading-relaxed text-ink/80">
            ...
            <section className="space-y-3">
              ...
              <p>
                We may collect your name, email address, and any other details
                you voluntarily include in a message. Technical data such as IP
                address, browser type, and approximate location may be
                processed by our hosting and analytics providers in standard web
                server logs.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                consent (for example optional marketing if we offer it and you
                opt in).
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                and to object or lodge a complaint with a supervisory authority.
                Contact us at hello@matalabs.io to exercise these rights.
              </p>
            </section>
