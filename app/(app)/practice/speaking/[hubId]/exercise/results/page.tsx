...
import { PracticeSpeakingResultsClient } from "@/components/bandforge/practice/practice-speaking-results-client";
...
export default async function PracticeSpeakingResultsPage({
  params,
  searchParams,
}: PageProps) {
  ...
  redirectIfUnauthenticated(
    user,
    `/practice/speaking/${hubId}/exercise/results?attempt=${attemptId}`,
    cookieHeader,
  );
