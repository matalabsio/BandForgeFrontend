...
import { PracticeWritingResultsClient } from "@/components/bandforge/practice/practice-writing-results-client";
...
export default async function PracticeWritingResultsPage({
  params,
  searchParams,
}: PageProps) {
  ...
  redirectIfUnauthenticated(
    user,
    `/practice/writing/${hubId}/exercise/results?attempt=${attemptId}`,
    cookieHeader,
  );
