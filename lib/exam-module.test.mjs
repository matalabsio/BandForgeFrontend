...
test("professional recommends General Training", () => {
  assert.equal(recommendExamModule("professional"), "general_training");
  assert.equal(requiresExplicitExamModuleChoice("professional"), false);
});

test("general improvement recommends General Training", () => {
  assert.equal(recommendExamModule("general"), "general_training");
  assert.equal(requiresExplicitExamModuleChoice("general"), false);
});
