...
/** Live catalog UUID for a slot number, or null if unavailable / coming soon. */
export function mockTestIdFromPanel(
  panel: MockCatalogSlot[],
  number: number,
): string | null {
...
/** Resolve catalog slot number for a mock UUID or legacy slug (m01/m02). */
