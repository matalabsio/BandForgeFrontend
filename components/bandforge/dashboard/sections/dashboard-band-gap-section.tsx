...
export function DashboardBandGapSection({
  ...
  return (
    <motion.section
      ref={rootRef}
      className="relative flex min-w-0 flex-col overflow-hidden rounded-[24px] border border-ink/8 bg-white px-5 py-6 shadow-[0_1px_0_rgba(255,255,255,0.8)_inset] sm:p-7"
