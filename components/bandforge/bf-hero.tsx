...
export function BandForgeHero() {
  return (
    ...
    >
      <div className="bf-container lg:px-10">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <div className="text-left lg:mx-0 lg:max-w-none">
            <BfSectionEyebrow className="mb-5 lg:mb-6">
              IELTS Diagnostic · 90 minutes
            </BfSectionEyebrow>
            <h1
              id="bf-hero-heading"
              className="font-display mb-[18px] text-[2.125rem] leading-[1.08] font-bold tracking-[-0.03em] text-balance text-navy lg:mb-6 lg:text-[3.5rem] lg:tracking-[-0.035em]"
            >
              If you took the IELTS today, what would your band be?
            </h1>
            <p className="mb-0 text-base leading-[1.6] text-muted lg:max-w-[46ch] lg:text-[1.1875rem]">
