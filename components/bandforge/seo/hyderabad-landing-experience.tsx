...
export function HyderabadLandingExperience() {
  return (
    <SeoAudienceLanding
      ...
      body="You do not need to visit a classroom. Take the diagnostic and Full Skill Program online — the same quality feedback Hyderabad coaching centres promise, at Rs. 2499 with a free starting point."
