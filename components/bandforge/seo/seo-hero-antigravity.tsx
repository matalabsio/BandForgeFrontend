...
const COLORS = ["#0097a7", "#00bcd4", "#0d1f3c"] as const;
...
/** Ambient antigravity particles for SEO page hero sections. */
export function SeoHeroAntigravity() {
  ...
  return (
    ...
    >
      <div
        className={
          isSmall
            ? "absolute inset-0 scale-[1.08]"
            : "absolute inset-0"
        }
        style={{ transformOrigin: "center center" }}
      >
        <Antigravity
          key={`seo-ag-${capsuleCount}-${sphereCount}`}
