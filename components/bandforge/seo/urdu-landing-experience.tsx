...
export function UrduLandingExperience() {
  return (
    <SeoAudienceLanding
      ...
      leadAnswer="BandForge helps Urdu-speaking students in Hyderabad and beyond find their real IELTS band before exam day — with a free diagnostic and the Full Skill Program (Rs. 2499)."
