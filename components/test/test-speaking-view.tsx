...
import { TestHeader, TestShell, TestTimer } from "@/components/test";
        ...
        <div className="mt-8 rounded-xl border border-border bg-surface p-6">
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              className={cn(
                "touch-target flex h-16 w-16 cursor-pointer items-center justify-center rounded-full text-body font-semibold text-white transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal focus-visible:ring-offset-2",
